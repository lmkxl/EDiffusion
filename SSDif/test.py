...
def main():
    ...
    if ARGS.dataset_selection == "cityscapes":
        ...
        test_dataset = VaihingenBuildingsLoader(root='/exp/home/mingkai.liu/data/Vaihingen_buildings', split='test', is_transform=True)
        ...
        test_dataset = ISICDatasetLoader(root='/exp/home/mingkai.liu/data/ISIC', split="test",img_size=256, is_transform=True, img_norm=True)
        ...
        test_dataset = hrfDatasetLoader(root=datas, split="test", img_size=256, is_transform=True, img_norm=True)
    elif ARGS.dataset_selection == "ph":
        test_dataset = PHDatasetLoader(root=datas, split="test", img_size=256, is_transform=True, img_norm=True)
    elif ARGS.dataset_selection == "five":
        test_dataset = FivesDatasetLoader(root=datas, split="test", img_size=256, is_transform=True, img_norm=True)
    elif ARGS.dataset_selection == "kvasir":
        test_dataset = KvasirDatasetLoader(root=datas, split="test", img_size=256, is_transform=True, img_norm=True)
